...
- 시각: 2026-06-28 (phase 11 step 1 — 대시보드 골격 + 모노크롬 + 라우팅 통과)
- 직전 작업(phase 11 step 1 dashboard shell):
...
| 11 dashboard-ui | step 1 ✅ / 2-4 pending | step 1: React Router + TanStack Query + 모노크롬 + AuthGate + 폴더 트리 + 메모리 리스트/상세(읽기). step 2: 마크다운 뷰어/편집 + 낙관적 락. step 3: 검색·아카이브·키 빌더. step 4: 단축키·상태·라이브 |
