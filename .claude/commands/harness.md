이 프로젝트는 Basic Harness 템플릿을 사용한다. 아래 워크플로우에 따라 작업을 진행하라.
...
`docs/HANDOFF.md`를 가장 먼저 읽고 현재 상태를 파악한다. 이어서 `docs/ROADMAP.md`, `docs/PRD.md`, `docs/ARCHITECTURE.md`, `docs/ADR.md`, 필요한 경우 `docs/UI_GUIDE.md`를 읽고 프로젝트의 기획·아키텍처·설계 의도를 파악한다. 필요시 Explore 에이전트를 병렬로 사용한다.
...
#### D-4. `docs/ROADMAP.md`와 `docs/HANDOFF.md`
